                ...
                <View className="w-5/6 mt-12">
                        ...
                        {(
                            ...
                            <>
                                ...
                                <TouchableOpacity
                                    ...
                                    className="bg-[#EA7D00] my-2 p-2 text-white rounded mt-8">
                    ...
                    <View className='mx-auto mt-6'>
                        <TouchableOpacity
                            ...
                            <Text className="font-semibold text-[18px] text-white">Already have an account?</Text>
                            <Text className=" font-semibold text-[20px] underline ml-2 text-[#EA7D00]">Sigin In</Text>
                        </TouchableOpacity>
                    </View>
